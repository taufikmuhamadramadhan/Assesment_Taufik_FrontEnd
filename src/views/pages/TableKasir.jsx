...
const KelolaDataDosenWali = () => {
  ...
  useEffect(() => {
    ...
    const apiUrl = 'http://localhost:8080/api/kasir/'
    ...
    axios
      ...
      .then((response) => {
        ...
        const KasirData = response.data.map((item) => {
          return {
            KodeKasir: item.KodeKasir,
            Nama: item.Nama,
            HP: item.HP,
          }
        })
  ...
  const handleDelete = (id) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setKasirData((prevData) => prevData.filter((barang) => barang.KodeBarang !== id))
  ...
  const filteredData = KasirData.filter((data) => {
    //Search filter data
    return (
      searchText === '' ||
      data.KodeKasir.toLowerCase().includes(searchText.toLowerCase()) ||
      data.Nama.toLowerCase().includes(searchText.toLowerCase()) ||
    ...
    <div>
      <CRow>
        <CCol>
          <CCard>
            <CCardBody>
              <div className="fw-bold mt-3 mb-5 title-page">Daftar Kasir</div>
              ...
              <CTable striped bordered responsive className="mt-2">
                <CTableHead>
                  <CTableRow>
                    ...
                    <CTableHeaderCell>Nama Kasir</CTableHeaderCell>
                ...
                <CTableBody>
                  {filteredData.length === 0 ? (
                    ...
                    filteredData.map((data) => (
                      <CTableRow key={data.KodeKasir}>
                        <CTableDataCell>{data.KodeKasir}</CTableDataCell>
